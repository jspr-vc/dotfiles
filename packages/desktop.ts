...
export default {
  hyprland: {
    ...
    uwsm: "session manager behind the hyprland-uwsm SDDM session",
    hypridle: "idle daemon",
    hyprlock: "screen locker",
    "hyprquery-git": "hyq, reads Hyprland config values from scripts",
    "gnome-keyring": "secret service for browsers, VS Code and gh",
    awww: "wallpaper daemon",
    "nwg-displays": "monitor layout GUI",
    "nwg-look": "GTK settings GUI",
    "libinput-gestures": "touchpad gestures",
    "zram-generator": "compressed swap in RAM, config written by install/services.sh",
  },
  ...
  audioBluetoothNetwork: {
    ...
    "pipewire-jack": "JACK apps through pipewire",
    "gst-plugin-pipewire": "GStreamer apps through pipewire",
    libpulse: "PulseAudio client library for cava, pamixer and friends",
  ...
  clipboardScreenshot: {
    ...
    swappy: "screenshot annotation behind bin/swappy",
